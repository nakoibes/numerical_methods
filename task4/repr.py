...
if __name__ == '__main__':
    with open("dots.txt") as f:
        ...
        a1_args = list(map(float, f.readline().split()))
        a1_vals = list(map(float, f.readline().split()))
        a2_args = list(map(float, f.readline().split()))
        a2_vals = list(map(float, f.readline().split()))
        ar_args = list(map(float, f.readline().split()))
        ar_vals = list(map(float, f.readline().split()))
